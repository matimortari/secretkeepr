<template>
  <div class="flex flex-col items-center justify-center bg-background p-8 md:flex-row md:p-24">
    <header
      v-motion class="flex flex-col items-center gap-8 border-b p-8 text-start md:flex-row md:border-0 md:border-r"
