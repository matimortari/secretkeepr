  ...
  <div v-motion :initial="{ opacity: 0 }" :enter="{ opacity: 1 }" :duration="800">
    ...
    <form class="flex flex-col" @submit.prevent="handleSubmit">
      ...
      <section class="flex flex-col px-8">
        <div
          v-for="(field, index) in userFields" :key="index"
        ...
        >
          ...
          <div v-else-if="field.type === 'image'" class="navigation-group md:navigation-group flex flex-col gap-1">
          ...
          <div v-else-if="field.copyable" class="navigation-group md:navigation-group flex flex-col gap-1">
